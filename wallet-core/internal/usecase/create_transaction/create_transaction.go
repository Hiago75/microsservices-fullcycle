...
func (uc *CreateTransactionUseCase) Execute(ctx context.Context, input CreateTransactionInputDTO) (*CreateTransactionOutputDTO, error) {
	...
	balanceUpdatedOuput := &BalanceUpdatedOutputDTO{}
	...
	err := uc.Uow.Do(ctx, func(_ *uow.Uow) error {
		...
		balanceUpdatedOuput.AccountIDFrom = input.AccountIDFrom
		balanceUpdatedOuput.AccountIDTo = input.AccountIDTo
		balanceUpdatedOuput.BalanceAccountIdFrom = accountFrom.Balance
		balanceUpdatedOuput.BalanceAccountIdTo = accountTo.Balance
	...
	uc.BalanceUpdated.SetPayload(balanceUpdatedOuput)
